...
import com.Nowshin.User;
import com.Nowshin.bo.CartBO;
import com.Nowshin.product.Product;
import com.Nowshin.util.Factory;
import com.Nowshin.util.Style;
...
public class UI {
    ...
    public void login() {
        ...
        user.setMobileNo(
                TakeInput.takeString("Enter your Mobile number(11digit):+88", "([0-9]).{10}", "mobile number: ",
                        false));
        mainPage();
    }
